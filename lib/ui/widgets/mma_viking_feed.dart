...
class MMAVikingFeedWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<RssFeed>(
        stream: Provider.of<RssFeedBloc>(context).mmaVikingStream,
                  ...
                  child: ExpansionTile(
                    title: Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          feed.items[index].pubDate.split("+0000")[0],
                    ...
                    children: <Widget>[
                      Padding(
                        padding: const EdgeInsets.all(16.0),
                        child: Text(
                          parse(feed.items[index].description)
                                  .documentElement
                                  .text ??
                              "",
